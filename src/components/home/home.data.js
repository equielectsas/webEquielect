export const BRANDS = [
  {
    name: "Equielect",
    images: {
      mobile: "/assets/Sliderhome/mobile/new_lauymob.jpg",
      mobile2x: "/assets/Sliderhome/mobile/new_lauymob.jpg",
      tablet: "/assets/Sliderhome/tablet/new_lautab.jpg",
      tablet2x: "/assets/Sliderhome/tablet/new_lautab.jpg",
