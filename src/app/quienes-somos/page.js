  ...
  const timelineData = [
    {
      ...
      desc: "Equielect nace en Medellín con el objetivo de ser el puente técnico entre los grandes fabricantes globales y la industria nacional, priorizando siempre la asesoría de ingeniería.",
    },
    {
      year: "2000",
      title: "Expansión Logística",
      desc: "Consolidamos nuestra sede principal y optimizamos los procesos de almacenamiento para garantizar la disponibilidad inmediata de componentes críticos en baja y media tensión.",
    },
    {
      year: "2015",
      title: "Alianzas Estratégicas",
      desc: "Fortalecemos nuestro portafolio como aliados de marcas líderes mundiales, asegurando trazabilidad y cumplimiento normativo RETIE en cada equipo suministrado.",
    },
    {
      year: "2026",
      title: "Liderazgo en Eficiencia",
      desc: "Nos posicionamos como referentes en soluciones para la transición energética y digitalización de redes inteligentes en el mercado colombiano.",
    },
  ];
    ...
    <div className="bg-white font-sans selection:bg-[#fae100] selection:text-[#1c355e]">
      ...
      <header className="relative w-full bg-white overflow-hidden">
        <div className="relative w-full">
          ...
          {/* ✅ Overlay mínimo para legibilidad del texto (NO blur, NO rellenos) */}
      ...
      <section id="profile" className="scroll-section py-28 px-6 max-w-7xl mx-auto">
        <div
          className={`grid lg:grid-cols-2 gap-20 items-center transition-all duration-1000 ${
            isVisible.profile ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-[#1c355e] uppercase tracking-tighter italic">
              Equielect S.A.S. <br />
              <span className="text-gray-400 font-light not-italic text-2xl">
                Solidez y Conocimiento Técnico
              </span>
            </h2>

            <div className="space-y-6 text-gray-700 text-lg leading-relaxed text-justify">
              <p>
                Desde nuestra fundación en Medellín en 1986, nos hemos dedicado a la
                comercialización y distribución técnica de materiales eléctricos de alta
                especificación. Nuestra identidad se fundamenta en la{" "}
                <strong>confianza técnica</strong>; entendemos que cada componente suministrado
                es vital para la continuidad operativa de nuestros clientes.
              </p>
              <p>
                Contamos con una infraestructura logística robusta que nos permite atender
                proyectos de gran envergadura en sectores como la minería, el petróleo, la
                construcción y la industria manufacturera, siempre bajo los más altos estándares
          ...
          <div className="relative grid grid-cols-2 gap-4">
            <img
              src="/assets/sucursal/corporativa3.jpg"
              alt="Instalaciones"
              className="w-full h-80 object-cover shadow-xl transition-all"
            />
            <img
              src="/assets/sucursal/corporativa1.jpg"
              alt="Equipo Técnico"
              className="w-full h-80 object-cover shadow-xl mt-12 transition-all"
            />
          </div>
        </div>
      </section>
      ...
      <section id="timeline" className="scroll-section py-32 relative overflow-hidden bg-white">
        ...
        <div
          className="absolute inset-0 z-0 opacity-[0.27]"
          style={{
                ...
                >
                  ...
                  <div
                    className={`pl-12 md:pl-0 md:w-1/2 flex ${
                      index % 2 === 0
                        ? "md:justify-start md:pl-24 text-left"
                        : "md:justify-end md:pr-24 md:text-right"
                    }`}
                  >
                    <div
                      className={`
                        ...
                        ${
                          index % 2 === 0
                            ? "border-l-8"
                            : "md:border-r-8 md:border-l-0 border-l-8"
                        }
                      `}
                    >
                      <span className="text-5xl font-black text-black transition-colors block mb-2 leading-none">
                        {item.year}
                      </span>
                      ...
                      <div
                        className={`hidden md:block absolute top-6 w-4 h-4 bg-white rotate-45 border-[#fae100]
      ...
      <section id="philosophy" className="scroll-section py-28 px-6 bg-[#1c355e] text-white">
        <div
          className={`max-w-7xl mx-auto grid md:grid-cols-2 gap-20 transition-all duration-1000 ${
            isVisible.philosophy ? "opacity-100" : "opacity-0 translate-y-10"
          }`}
        >
          <div className="space-y-8">
            <h3 className="text-[#fae100] text-3xl font-black uppercase italic tracking-tighter border-b-2 border-[#fae100] pb-4 inline-block">
              Misión
            </h3>
      ...
      <section id="compliance" className="scroll-section py-24 px-6 max-w-7xl mx-auto">
        <div
          className={`grid lg:grid-cols-3 gap-12 items-center transition-all duration-1000 ${
            isVisible.compliance ? "opacity-100" : "opacity-0"
          }`}
        >
          <div className="lg:col-span-1">
            <div className="p-8 bg-gray-50 border-l-8 border-[#fae100]">
              <h2 className="text-2xl font-black text-[#1c355e] uppercase italic mb-4">
                Compromiso <br />RETIE
              </h2>
          ...
          <div className="lg:col-span-2 text-gray-700 text-lg font-light leading-relaxed">
            <p>
              En <strong>Equielect S.A.S.</strong>, la seguridad no es negociable. Todos nuestros
              productos cumplen estrictamente con el Reglamento Técnico de Instalaciones Eléctricas (RETIE).
              Mantenemos una trazabilidad total de nuestros equipos, asegurando que cada componente posea los
              certificados de conformidad vigentes exigidos por la ley colombiana.
            </p>
          </div>
        </div>
      </section>
